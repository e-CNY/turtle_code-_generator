...
2.打开LM Studio、Ollama等并开启本地API服务
3. 打开海龟编辑器2，新建Python作品，打开库管理，搜索openai和pyperclip并安装。
...
2. Open LM Studio, Ollama, etc. and open local API services
3. Open Turtle Editor2, create a new Python work, open library management, search for openai and pyperclip, and install it.
